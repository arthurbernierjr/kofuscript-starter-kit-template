...
"use strict";
eval("/* harmony import */ var _models_Item__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../models/Item */ \"./lib/components/models/Item.js\");\n\nvar module = {\n  exports: {}\n};\nvar exports = module.exports;\n// Generated by KofuScript 0.0.3-alpha.7\nvar present = console.log; // Generated by KofuScript 0.0.3-alpha.7\n\nvar Item, List;\nItem = _models_Item__WEBPACK_IMPORTED_MODULE_0__[/* default */ \"a\"];\n\nList = function (super$) {\n  extends$(List, super$);\n\n  function List() {\n    super$.apply(this, arguments);\n  }\n\n  List.prototype.model = Item;\n  return List;\n}(Backbone.Collection);\n\nmodule.exports = List;\n\nfunction isOwn$(o, p) {\n  return {}.hasOwnProperty.call(o, p);\n}\n\nfunction extends$(child, parent) {\n  for (var key in parent) if (isOwn$(parent, key)) child[key] = parent[key];\n\n  function ctor() {\n    this.constructor = child;\n  }\n\n  ctor.prototype = parent.prototype;\n  child.prototype = new ctor();\n  child.__super__ = parent.prototype;\n  return child;\n}\n\n/* harmony default export */ __webpack_exports__[\"a\"] = (module.exports);\n\n//# sourceURL=webpack:///./lib/components/collections/List.js?");
